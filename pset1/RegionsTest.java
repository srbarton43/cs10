...
public class RegionsTest extends DrawingGUI {
	 ...
	 * @param color
	 */
	public RegionsTest(String name, RegionFinder1 finder, Color targetColor) {
	...
	public static void main(String[] args) { 
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				//new RegionsTest("smiley", new RegionFinder1(loadImage("pictures/smiley.png")), new Color(0, 0, 0));
				//new RegionsTest("baker", new RegionFinder1(loadImage("pictures/baker.jpg")), new Color(131, 106, 99));
				new RegionsTest("baker", new RegionFinder1(loadImage("pictures/baker.jpg")), new Color(130, 100, 100));
			}
		});
	}
}
